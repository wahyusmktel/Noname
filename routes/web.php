...
Route::middleware('auth')->group(function () {
    ...
    // =========================================================================
    // 1. MODUL KHUSUS ADMIN BIMBEL & SUPERADMIN
    // =========================================================================
    Route::middleware('role:admin_bimbel,superadmin')->group(function () {
    ...
    // =========================================================================
    // 2. MODUL KHUSUS GURU (TUTOR) & ADMIN
    // =========================================================================
    Route::middleware('role:tutor,admin_bimbel,superadmin')->group(function () {
    ...
    // =========================================================================
    // 3. MODUL KHUSUS ORANG TUA / SISWA & ADMIN
    // =========================================================================
    Route::middleware('role:siswa,orang_tua,admin_bimbel,superadmin')->group(function () {
